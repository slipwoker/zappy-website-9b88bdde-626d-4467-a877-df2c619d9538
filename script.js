...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('input', (e) => {
      if (e.target.matches('[name="name"], [name="email"], [name="message"]')) {
        clearError(e.target);
      }
    });
  }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9b88bdde-626d-4467-a877-df2c619d9538',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9b88bdde-626d-4467-a877-df2c619d9538';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9b88bdde-626d-4467-a877-df2c619d9538';
